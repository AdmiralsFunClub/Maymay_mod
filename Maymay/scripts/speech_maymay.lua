...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Are you cray cray??",
			GENERIC = "I can't shave that!",
			NOBITS = "There ain't nothin' to shave!",
		},
		STORE =
		{
			GENERIC = "Too much stuff!.",
			NOTALLOWED = "That don't go there!.",
			INUSE = "Siiiiiiiigh...",
		},
		RUMMAGE =
		{	
        ...
        COOK =
        {
            GENERIC = "Cannot!",
            INUSE = "Siiiiiiiigh...",
            TOOFAR = "It's way over there!",
        },
        GIVE =
        {
            DEAD = "What they gonna do with that?",
            SLEEPING = "Wake up!",
            BUSY = "Siiiiiiiigh...",
        },
        GIVETOPLAYER = 
        {
        	FULL = "You got too much stuff!",
            DEAD = "What they gonna do with that?",
            SLEEPING = "Wake up!",
            BUSY = "Siiiiiiiigh...",
    	},
        ...
        {
            GENERIC = "Cannot!",
            INUSE = "I gotta write somethin' down!",
        },
        CHANGEIN =
        {
            GENERIC = "Cannot!",
            BURNING = "Da na na hot hot hot!",
            INUSE = "Nope!",
        },
        ATTUNE =
        {
            NOHEALTH = "Are you cray cray? That'll kill me!",
        },
	},
	ACTIONFAIL_GENERIC = "Cannot!",
	ANNOUNCE_ADVENTUREFAIL = "That didn't go well. I'll have to try again.",
	ANNOUNCE_BEES = "AH!!!",
	ANNOUNCE_BOOMERANG = "Owie!",
	ANNOUNCE_CHARLIE = "Someone in da darkness!",
	ANNOUNCE_CHARLIE_ATTACK = "It bit my butt!",
	ANNOUNCE_COLD = "Don't like no cold takos!",
	ANNOUNCE_HOT = "*pant pant*",
	ANNOUNCE_CRAFTING_FAIL = "Need more ingredients!",
	ANNOUNCE_DEERCLOPS = "Uh oh! Somethin' big comin'!",
	ANNOUNCE_DUSK = "Gettin' dark out!",
	ANNOUNCE_EAT =
	{
		GENERIC = "Yummy!",
		PAINFUL = "Bleh my tummy hurts...",
		SPOILED = "Ew gross!",
		STALE = "It's stale!",
		INVALID = "I can't eat that!",
		YUCKY = "Ew gross!",
	},
	ANNOUNCE_ENTER_DARK = "Da darkness...",
	ANNOUNCE_ENTER_LIGHT = "Nightlight for the tako!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "Me smartie!",
	ANNOUNCE_HOUNDS = "Puppers comin'!",
	ANNOUNCE_WORMS = "Time for worms!",
	ANNOUNCE_HUNGRY = "I'm hungee!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Sumi-chan is close!",
	ANNOUNCE_HUNT_LOST_TRAIL = "She got away!",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Ground's too wet to even hold Sumi's footprints!",
	ANNOUNCE_INV_FULL = "Can't carry any more than that!",
	ANNOUNCE_KNOCKEDOUT = "Ouchies!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "AH!!",
    ANNOUNCE_NOWARDROBEONFIRE = "Da na na hot hot hot!",
    ANNOUNCE_NODANGERGIFT = "Is you cray cray?",
	ANNOUNCE_NODANGERSLEEP = "Too dangerous!",
	ANNOUNCE_NODAYSLEEP = "Bleh too bright out.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "I'm too hungee to sleep!",
	ANNOUNCE_NOSLEEPONFIRE = "Da na na hot hot hot!",
	...
	ANNOUNCE_NODANGERAFK = "We're still fighting!",
	ANNOUNCE_NO_TRAP = "Well, that was easy.",
	ANNOUNCE_PECKED = "Owie!",
	ANNOUNCE_QUAKE = "EARTHQUAAAKE!",
	ANNOUNCE_RESEARCH = "Never stop learning!",
	ANNOUNCE_SHELTER = "Don't want no wet takos!",
	ANNOUNCE_THORNS = "Owie!",
	ANNOUNCE_BURNT = "Da na na hot hot hot!",
	ANNOUNCE_TORCH_OUT = "I'm in da dark!",
	...
	ANNOUNCE_WORMHOLE = "Wheee!",
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "Check this out!",
	...
	ANNOUNCE_TOOL_SLIP = "Get back here!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Close one!",

	ANNOUNCE_DAMP = "Don't want no wet takos!",
	ANNOUNCE_WET = "Too wet!",
	ANNOUNCE_WETTER = "I'm not happy!",
	ANNOUNCE_SOAKED = "WAH!",
	...
	DESCRIBE =
	{
		...
		TENTACLE = "Hello fellow takos!",
		TENTACLESPIKE = "This is my kinda weapon!",
		TENTACLESPOTS = "Fallen takos, you shall be avenged!",
		TENTACLE_PILLAR = "Giant tako!",
        TENTACLE_PILLAR_HOLE = "Some giant takos live down there.",
		TENTACLE_PILLAR_ARM = "Little tako tentacle!",
		TENTACLE_GARDEN = "Lotsa takos!",
		...
		TRINKET_12 = "That makes me sad.", --Dessicated Tentacle
